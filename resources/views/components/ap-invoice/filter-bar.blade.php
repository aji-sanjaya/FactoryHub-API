<div x-data="{
    ...
    resetFilters() {
        this.filters = { date_start: '', date_end: '', status: '' };
        this.applyFilters();
    }
}"
    ...
    <div class="flex items-center gap-3">
        <div class="relative">
            ...
            <input type="text" placeholder="Search Invoice" id="searchInput"
    ...
    <div class="flex items-center gap-3 relative">
        ...
        <div x-show="openFilter" @click.outside="openFilter = false"
            ...
            <div class="space-y-4">
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Invoice Date</label>
        ...
        <a href="{{ route('ap-invoice.index', ['document_id' => 'new']) }}"
