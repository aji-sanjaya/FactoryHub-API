                    ...
                    <tr class="border-t border-gray-200 dark:border-gray-800 hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('ap-invoice.index', ['document_id' => \Illuminate\Support\Facades\Crypt::encryptString($invoice->c_invoice_id)]) }}"
                                ...
                                @if($invoice->docstatus !== 'VO')
                                    <button type="button"
                                        onclick="openPrintModal('{{ route('ap-invoice.print', ['id' => \Illuminate\Support\Facades\Crypt::encryptString($invoice->c_invoice_id)]) }}')"
