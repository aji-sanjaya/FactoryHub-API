        ...
        <table class="w-full table-auto">
            ...
            <tbody>
                @forelse ($payments as $index => $payment)
                    @php
                        $customerName = \Illuminate\Support\Facades\DB::connection('idempiere')
                            ->table('c_bpartner')
                    ...
                    <tr class="border-t border-gray-200 dark:border-gray-800 hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('ar-receipt.index', ['document_id' => \Illuminate\Support\Facades\Crypt::encryptString($payment->c_payment_id)]) }}"
