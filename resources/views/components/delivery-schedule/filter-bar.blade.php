    ...
    <div class="flex items-center gap-3 relative">
        ...
        <div x-show="openFilter" @click.outside="openFilter = false"
            ...
            <div class="space-y-4">
                ...
                <!-- Date Range -->
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Date Required</label>
                    <div class="flex gap-2">
                        <input type="date" x-model="filters.date_required_start"
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:text-white" />
                        <span class="self-center text-gray-500">-</span>
                        <input type="date" x-model="filters.date_required_end"
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:text-white" />
                    </div>
                </div>
        ...
        <!-- Create Button -->
        <a href="{{ route('delivery-schedule.index', ['document_id' => 'new']) }}"
            class="inline-flex items-center justify-center gap-2 rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2">
            <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M8.00004 2.33331C8.41425 2.33331 8.75004 2.6691 8.75004 3.08331V7.24998H12.9167C13.3309 7.24998 13.6667 7.58577 13.6667 7.99998C13.6667 8.41419 13.3309 8.74998 12.9167 8.74998H8.75004V12.9166C8.75004 13.3309 8.41425 13.6666 8.00004 13.6666C7.58583 13.6666 7.25004 13.3309 7.25004 12.9166V8.74998H3.08337C2.66916 8.74998 2.33337 8.41419 2.33337 7.99998C2.33337 7.58577 2.66916 7.24998 3.08337 7.24998H7.25004V3.08331C7.25004 2.6691 7.58583 2.33331 8.00004 2.33331Z"
                    fill="" />
            </svg>
            Create
        </a>
