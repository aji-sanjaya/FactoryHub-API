<div x-data="{
    openFilter: false,
    filters: { description: '', date_start: '', date_end: '', status: '' },
    applyFilters() {
        this.openFilter = false;
        document.dispatchEvent(new CustomEvent('filter-applied', { detail: this.filters }));
    },
    resetFilters() {
        this.filters = { description: '', date_start: '', date_end: '', status: '' };
        this.applyFilters();
    }
        ...
        <div class="relative">
            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                <svg class="fill-current" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.04199 9.25C3.04199 5.82165 5.82165 3.04199 9.25 3.04199C12.6784 3.04199 15.458 5.82165 15.458 9.25C15.458 12.6784 12.6784 15.458 9.25 15.458C5.82165 15.458 3.04199 12.6784 3.04199 9.25ZM9.25 1.54199C4.99339 1.54199 1.54199 4.99339 1.54199 9.25C1.54199 13.5066 4.99339 16.958 9.25 16.958C11.1259 16.958 12.8443 16.2891 14.1953 15.1763L16.9427 17.9237C17.2356 18.2166 17.7105 18.2166 18.0034 17.9237C18.2963 17.6308 18.2963 17.1559 18.0034 16.863L15.256 14.1156C16.3688 12.7646 17.042 11.0462 17.042 9.25C17.042 4.99339 13.5066 1.54199 9.25 1.54199Z" fill="" />
                </svg>
            </span>
    ...
    <div class="flex items-center gap-3 relative">
        ...
        <div x-show="openFilter" @click.outside="openFilter = false"
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Movement Date</label>
        ...
        <a href="{{ route('material-receipt.create') }}"
