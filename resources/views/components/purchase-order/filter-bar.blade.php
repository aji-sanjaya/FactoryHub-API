    ...
    <div class="flex items-center gap-3 relative">
        ...
        <div x-show="openFilter" @click.outside="openFilter = false"
            ...
            <div class="space-y-4">
                ...
                <!-- Date Range -->
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Date Ordered</label>
                    <div class="flex gap-2">
                        <input type="date" x-model="filters.date_ordered_start"
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:text-white" />
                        <span class="self-center text-gray-500">-</span>
                        <input type="date" x-model="filters.date_ordered_end"
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:text-white" />
                    </div>
                </div>
