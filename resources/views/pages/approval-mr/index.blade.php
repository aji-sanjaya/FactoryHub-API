    ...
    <div class="main-content group-data-[sidebar-size=lg]:xl:ml-[322px]">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">Approval MR</li>
                </ol>
            </nav>
        </div>
        ...
        <div id="table-container" class="relative min-h-[400px]">
            ...
            <div id="table-content">
                @include('pages.approval-mr.partials.table', ['receipts' => $receipts])
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (typeof $ !== 'undefined') {
                ...
                $('#supplierFilter').select2({
                    ajax: {
                        url: '{{ route("approval-mr.suppliers") }}',
                        dataType: 'json',
                        delay: 250,
        ...
        function fetchData(page = 1) {
            ...
            const newUrl = "{{ route('approval-mr.index') }}?" + params.toString();
