...
@section('content')
    @php
        ...
        $canTakeAction = in_array($receipt->docstatus, $statusConfig['actionable']) && $isMyApproval;
    @endphp
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    <a href="{{ route('approval-mr.index') }}"
                ...
                <div class="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400 ml-7">
                    ...
                    <span>{{ date('d M Y', strtotime($receipt->movementdate)) }}</span>
            ...
            <div id="tab-content">
                ...
                <div id="document-panel" class="block">
                    <div class="p-0 overflow-hidden bg-gray-100 dark:bg-gray-800" style="height: calc(100vh - 250px);">
                        <iframe src="{{ route('material-receipt.print', ['document_id' => $encryptedId]) }}"
...
@push('scripts')
    ...
    <script>
        ...
        function loadAttachments() {
            ...
            axios.get('{{ route("approval-mr.show", $encryptedId) }}', {
        ...
        function handleApproval(action) {
            ...
            Swal.fire({
                ...
                preConfirm: (comment) => {
                    return axios.post('{{ route("approval-mr.process", $encryptedId) }}', {
                        action: action,
                        comment: comment
                    })
                        .then(response => {
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "{{ route('approval-mr.index') }}";
                    });
                }
            });
        }
