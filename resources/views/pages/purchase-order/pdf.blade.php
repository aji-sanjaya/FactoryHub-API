...
<head>
    ...
    <style>
        ...
        .info-label {
            font-weight: bold;
            /* Optional: make labels bold matches image? Image labels are normal weight but keys like "Order to" seem standard */
            width: 100px;
        }
                ...
                <td style="padding: 0;">
                        ...
                        <tbody>
                            ...
                            @foreach($lines as $index => $line)
                                ...
                                <tr>
                                    ...
                                    <td>{{ !empty($line->datepromised) ? \Carbon\Carbon::parse($line->datepromised)->format('d M Y') : '' }}
                                    </td>
                    ...
                    <div class="provision-section">
                        ...
                        <ol class="provision-list" style="margin-top: 5px; padding-left: 20px;">
                            ...
                            <li>Good which are not meet with the requirement (specification and condition), will be
                                returned.</li>
