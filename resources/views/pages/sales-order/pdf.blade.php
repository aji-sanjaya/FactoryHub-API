...
<head>
    ...
    <title>Purchase Sales Order {{ $salesOrder->documentno }}</title>
    <style>
        body {
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="info-cell">
                    ...
                    <div class="info-row"><span class="info-label">Eff. Date</span>: {{ date('d M Y', strtotime($salesOrder->datedoc)) }}</div>
        ...
        <div class="sub-header">
            <table>
                <tr>
                    ...
                    <td width="35%">: {{ $salesOrder->documentno }}</td>
                    <td width="20%">Expected Delivery</td>
                    <td width="30%">: {{ date('d M Y', strtotime($salesOrder->datepromised)) }}</td>
                </tr>
                <tr>
                    <td>Date</td>
                    <td>: {{ date('d M Y', strtotime($salesOrder->dateordered)) }}</td>
                    <td>PO Number</td>
                    <td>: {{ $salesOrder->poreference }}</td>
                </tr>
            </table>
        </div>
